...
function GroupChat(props) {
    ...
    return (
        <div className={styles.groupchatUser}>
            ...
            {props.name === "" ? (
                ...
                <>
                    <div className={styles.gcinbox}>
                        {props.messages.map((message, index) => {
                            return (
                                <div className={styles.withName}>
                                    {props.senderName!==message.senderName?<div>{message.senderName}</div>:null}
                    ...
                    <div className={styles.gcchatSend}>
                        <TextField
