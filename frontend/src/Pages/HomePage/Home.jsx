    ...
    <div className={styles.mainDiv}>
      ...
      <div className={styles.features}>
        <Card
          ...
          onClick={() => history.push("/findProfessionals")}
        >
          <CardMedia
          ...
          >
            Seek out the most suitable Mental Health Expert for You and schedule
            an appointment.
          </Typography>
        </Card>
        <Card
        ...
        >
          ...
          <Typography
            ...
            color="text.secondary"
          >
            Ask mental Health related questions and get answers from
            professionals.
          </Typography>
        </Card>
        <Card
        ...
        >
          ...
          <Typography
            ...
            color="text.secondary"
          >
            Read insights and advice from Professionals and share experiences
        ...
        <Card
          variant="outlined"
          className={styles.featureCard}
          onClick={() => history.push("/groupChat")}
        >
          <CardMedia
            className={styles.featureLogo}
            component="img"
      ...
      <div className={styles.appointments}>
        ...
        <Card variant="outlined" className={styles.appointmentCard}>
          ...
          <div className={styles.btnDiv}>
            <Button className={styles.joinBtn} variant="outlined">
              Join Session
            </Button>
